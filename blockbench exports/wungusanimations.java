 ...
 * @author Author
 */
public class wungusAnimation {
	public static final AnimationDefinition better walk = AnimationDefinition.Builder.withLength(1.0F).looping()
	...
	public static final AnimationDefinition better run = AnimationDefinition.Builder.withLength(0.5F).looping()
		.addAnimation("legR", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
