...
public class wungus<T extends Animal> extends EntityModel<T> {
	...
	@Override
	public void setupAnim(Animal entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
