...
public class ModItems {
    ...
    public static final RegistryObject<Item> AILANTHUS_SIGN = ITEMS.register("ailanthus_sign",
            () -> new SignItem(new Item.Properties().stacksTo(16), ModBlocks.AILANTHUS_SIGN.get(), ModBlocks.AILANTHUS_WALL_SIGN.get()));
    public static final RegistryObject<Item> AILANTHUS_HANGING_SIGN = ITEMS.register("ailanthus_hanging_sign",
